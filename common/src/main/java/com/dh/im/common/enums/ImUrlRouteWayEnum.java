...
public enum ImUrlRouteWayEnum {
     ...
     * 随机
     */
    RANDOM(1, "com.dh.im.common.route.algorithm.random.RandomHandle"),


    /**
     * 1.轮询
     */
    LOOP(2, "com.dh.im.common.route.algorithm.loop.LoopHandle"),

    /**
     * HASH
     */
    HASH(3, "com.dh.im.common.route.algorithm.consistenthash.ConsistentHashHandle"),
    ;
