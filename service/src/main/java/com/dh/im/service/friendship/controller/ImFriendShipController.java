...
public class ImFriendShipController {
    ...
    public ResponseVO updateFriend(@RequestBody @Validated UpdateFriend req, Integer appId) {
    ...
    @RequestMapping("/getRelationFriend")
    public ResponseVO getRelationFriend(@RequestBody @Validated GetRelationReq req, Integer appId) {

        req.setAppId(appId);
        return imFriendShipService.getRelationFriend(req);
    }
