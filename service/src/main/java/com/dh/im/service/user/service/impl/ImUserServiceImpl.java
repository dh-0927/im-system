...
import com.dh.im.codec.park.user.UserModifyPack;
...
import com.dh.im.service.user.dao.mapper.ImUserDataMapper;
import com.dh.im.service.user.model.req.*;
import com.dh.im.service.user.model.resp.GetUserInfoResp;
import com.dh.im.service.user.model.resp.ImportUserResp;
...
public class ImUserServiceImpl implements ImUserService {
    ...
    // 从redis中获取sequence，群组没有存，需单独获取
    @Override
    public ResponseVO getUserSequence(GetUserSequenceReq req) {
        Map<Object, Object> map =
                stringRedisTemplate.opsForHash().entries(
                        req.getAppId() + ":" +
                                Constants.RedisConstants.SeqPrefix + ":" + req
                                .getUserId());
