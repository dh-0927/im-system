...
@Slf4j
@Service
public class StorePGroupMessageReceiver {
    ...
    public void onChatMessage(@Payload Message message,
        ...
        log.info("store group meg from queue ：：：{}", msg);
        ...
        try {
            ...
            log.error("持久化群聊消息出现异常：{}", e.getMessage());
            log.error("RMQ_GORUP_STORE_TRAN_ERROR", e);
